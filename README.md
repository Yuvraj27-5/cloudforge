...
[![CI](https://github.com/USERNAME/cloudforge/actions/workflows/ci.yml/badge.svg)](https://github.com/USERNAME/cloudforge/actions/workflows/ci.yml)
...
> **Status: Phase 6 complete.** Project management works end to end. No risk model,
